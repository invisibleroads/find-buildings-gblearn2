...
% endif
& \
${'%5.1f \%%' % float(preparedResult['location_predictedNotActualOverPredicted'])} & \
${'%5.1f \%%' % float(preparedResult['location_actualNotPredictedOverActual'])} & \
